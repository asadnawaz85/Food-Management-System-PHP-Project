...
$query="SELECT * FROM food_order WHERE user_sid=$user_id ORDER BY id DESC";
    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold"><a href="user-page.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Food Menu</a>
            </li>
                <li class="no-padding">
             ...
             <li class="bold active"><a href="all-orders-user.php" class="waves-effect waves-cyan"><i class="mdi-editor-insert-invitation"></i>All Orders</a>
            </li> 
            <li class="bold"><a href="yet-to-be-deliver-orders-user.php" class="waves-effect waves-cyan"><i class="mdi-editor-insert-invitation"></i>Orders Yet To Be Deliver</a>
            </li>
            <li class="bold"><a href="Approved-by-Admin-user.php" class="waves-effect waves-cyan"><i class="mdi-editor-insert-invitation"></i>Orders Appreoved</a>
            </li> 
            <li class="bold"><a href="cancel-by-user.php" class="waves-effect waves-cyan"><i class="mdi-editor-insert-invitation"></i>Cancel by user</a>
            </li> 
                ...
                <div>
					...
					<li class="collection-item avatar">
                              ...
                              <p><strong>Status:</strong><div class="btn white-text bg-primary"><?php echo $row['status']; ?></div></p>
                                ...
                                ?>
                                <?php 
                                                if($row['status']=='Cancel by User'): 
                                ?>                        
                              <p><strong>Status:</strong><div class="btn white-text bg-danger"><?php echo $row['status']; ?></div></p>
                                <?php
                                                endif;
                                ?>
                            ...
                            <li class="collection-item">
                                        <div class="row">
                                            ...
                                            <a href="change_status-user.php?rdid=<?php echo $row['id'];?>" class="btn waves-effect waves-light right submit" style="color: white;background-color: red;">Cancel</a>
                                            <?php
                                                endif;
                                            ?>
                                            <?php 
                                                if($row['status']=='Cancel by User'): 
                                            ?>
                                            <a href="change_status-user.php?rid=<?php echo $row['id'];?>" class="btn waves-effect waves-light right submit" style="color: white;background-color: black;">Re Active</a>
                                            <?php
                                                endif;
                                            ?>
