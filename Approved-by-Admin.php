...
$query="SELECT * FROM food_order WHERE status='Approved by Admin' ORDER BY id DESC ";
$data = [];
    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold active"><a href="Approved-by-Admin.php" class="waves-effect waves-cyan"><i class="mdi-editor-insert-invitation"></i>Orders Appreoved</a>
            </li> 
