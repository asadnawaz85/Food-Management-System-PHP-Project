...
$query="SELECT * FROM food_order WHERE status='Yet to be Delivered' AND user_sid=$user_id ORDER BY id DESC ";
$data = [];
    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold active"><a href="yet-to-be-deliver-orders-user.php" class="waves-effect waves-cyan"><i class="mdi-editor-insert-invitation"></i>Orders Yet To Be Deliver</a>
            </li>
