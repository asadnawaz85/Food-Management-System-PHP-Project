...
$query="SELECT * FROM food_order WHERE status='Approved by Admin' AND user_sid=$user_id ORDER BY id DESC ";
$data = [];
    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold active"><a href="Approved-by-Admin-user.php" class="waves-effect waves-cyan"><i class="mdi-editor-insert-invitation"></i>Orders Appreoved</a>
            </li> 
