      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold"><a href="index.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Food Menu</a>
             ...
             <li class="bold active"><a href="all-orders.php" class="waves-effect waves-cyan"><i class="mdi-editor-insert-invitation"></i>All Orders</a>
            </li> 
            <li class="bold"><a href="yet-to-be-deliver-orders.php" class="waves-effect waves-cyan"><i class="mdi-editor-insert-invitation"></i>Orders Yet To Be Deliver</a>
            </li>
                            ...
                            <li class="collection-item">
                                        <div class="row">
                                            ...
                                            <?php 
                                                if($row['status']=='Approved by Admin'): 
                                            ?>
                                            <a href="change_status.php?rid=<?php echo $row['id'];?>" class="btn waves-effect waves-light right submit" style="color: white;background-color: red;">Paused</a>
                                            <?php
                                                endif;
                                            ?>
                                            <?php 
                                                if($row['status']=='Yet to be Delivered'): 
                                            ?>
                                            <a href="change_status.php?rdid=<?php echo $row['id'];?>" class="btn waves-effect waves-light right submit" style="color: white;background-color: red;">Approved</a>
                                            <?php
                                                endif;
                                            ?>
                                            <?php 
                                                if($row['status']=='Cancel by User'): 
                                            ?>
                                            <a href="delete_status.php?rid=<?php echo $row['id'];?>" class="btn waves-effect waves-light right submit" style="color: white;background-color: red;">Delete</a>
                                            <?php
                                                endif;
                                            ?>
