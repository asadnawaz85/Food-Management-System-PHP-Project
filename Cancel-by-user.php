...
$query="SELECT * FROM food_order WHERE status='Cancel by User' AND user_sid=$user_id ORDER BY id DESC ";
$data = [];
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold"><a href="user-page.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Food Menu</a>
             ...
             <li class="bold"><a href="all-orders-user.php" class="waves-effect waves-cyan"><i class="mdi-editor-insert-invitation"></i>All Orders</a>
            </li> 
            ...
            <li class="bold active"><a href="cancel-by-user.php" class="waves-effect waves-cyan"><i class="mdi-editor-insert-invitation"></i>Cancel by user</a>
            </li>  
					...
					<li class="collection-item avatar">
                            ...
                            <li class="collection-item">
                                        <div class="row">
                                            ...
                                            <a href="change_status2-user.php?rdid=<?php echo $row['id'];?>" class="btn waves-effect waves-light right submit" style="color: white;background-color: red;">Cancel</a>
