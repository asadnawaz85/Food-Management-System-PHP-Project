...
$query="SELECT * FROM food_order WHERE status='Cancel by User' ORDER BY id DESC ";
$data = [];
    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold active"><a href="cancel-orders.php" class="waves-effect waves-cyan"><i class="mdi-editor-insert-invitation"></i>Canceled Orders</a>
            </li>  
